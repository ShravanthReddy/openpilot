...
_ENTERING_PRED_LAT_ACC_TH = 1.35  # Predicted Lat Acc threshold to trigger entering turn state.
_ABORT_ENTERING_PRED_LAT_ACC_TH = 1.15  # Predicted Lat Acc threshold to abort entering state if speed drops.
